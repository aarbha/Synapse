...
export function BongoCat() {
  return (
    <section className="py-24 px-6 border-t border-[#114C5A] bg-[#050505] flex flex-col items-center overflow-hidden">
      <div className="max-w-2xl mb-12 text-center">
        <h2 className="text-3xl md:text-4xl font-medium tracking-tight mb-4 text-[#F1F6F4]">
      ...
      <div className="w-full max-w-2xl h-[300px] md:h-[400px] relative bongo-container">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 783.55 354.91" className="w-full h-full overflow-visible">
          <g id="bongo-cat">
            <g className="head">
            ...
            <g className="table">
              ...
              <line x1="25.3" y1="158.5" x2="783.2" y2="293" fill="none" stroke="#8d00fc" strokeMiterlimit="10" strokeWidth="4"/>
